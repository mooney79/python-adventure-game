...
typing_print(f"GHOST: Well {player_name} if you reach around I think there's a flashlight somewhere.\n") 
...
typing_print("The trunk opens and buried at the bottom of the trunk you find a crowbar. While you haven't figured out how you're going to get out of the attic yet, you realize this might just be the tool you need.")
typing_print("and who knows what else is lurking downstairs and in other parts of the house.")
typing_print("the ghost is now hovering over an area that looks to be an exit. you take a breath and realize that you can't stay here forever and it's time to face whatever stands in your way of getting out of this godforsaken house.") 
